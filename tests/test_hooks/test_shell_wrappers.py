...
git_pull_on_start, check_dep_freshness).
...
(pyright/bandit/semgrep checks were retired 2026-08-13 from the Claude-hook
layer entirely — they now run in the git pre-commit hook, covered by
tests/test_hooks/test_precommit_hook.py.)
